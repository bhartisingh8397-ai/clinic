...
<main>
    ...
    <section class="hero"
        ...
        <div class="container hero-content" data-aos="fade-up">
            <span class="badge"
                style="background: var(--accent); color: var(--primary); font-weight: 700; border: none;">PREMIUM
                DERMATOLOGY</span>
            <h1 class="hero-title">Renowned Dermatology Clinic<br><span class="accent-text"
                    style="font-style: italic; color: var(--accent);">in Sonipat</span></h1>
            <p>
                Dr. Praveen Lakra offers a bespoke approach to skin health, combining cutting-edge medical science with
                a refined aesthetic eye.
            </p>
            <div class="hero-btns">
                <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn">Schedule Consultation</a>
                <a href="<?php echo esc_url(home_url('/about/')); ?>" class="btn" style="margin-left: 20px;">Experience
                    Excellence</a>
            </div>
        </div>
    </section>
